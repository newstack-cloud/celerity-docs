...
Applications with public HTTP APIs that make up Celerity such as the [Workflow Runtime](/workflow-runtime/docs/intro) support common authentication mechanisms including API keys and JWTs issued by [OAuth2](https://oauth.net/2/) or OIDC[^1] providers.
