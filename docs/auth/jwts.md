...
JWTs (JSON Web Tokens) can be used to authenticate with Celerity components that provide HTTP APIs such as the [Workflow Runtime](/workflow-runtime/docs/intro).
