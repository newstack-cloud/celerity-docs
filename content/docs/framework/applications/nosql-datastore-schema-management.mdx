...
This is explicitly opt-in and expensive — data teams or developers run it when they need to understand data quality, not as part of every deploy. This is projected as a paid tier feature for a future release after v1 (post-July 2027).
</Callout>
