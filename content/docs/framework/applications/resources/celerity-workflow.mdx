...
- **v1 (Preview)**: Multi-cloud with support for deployment as containerised applications as well as serverless workflow deployments.

Read more about Celerity versions [here](/docs/framework/versions).
</Callout>

🚀 **Planned for v1** - Support for workflow applications is planned for v1, they may become available in a future v0 evolution.
