...
- **v0 (Current)**: AWS serverless (Step Functions) and local development with the Celerity workflow runtime. Node.js and Python runtimes only.
...
✅ **Available in v0** - Workflow support is available in v0 for local development and AWS serverless (Step Functions) deployments with Node.js and Python runtimes. Full multi-cloud and containerised deployment support is planned for v1.
