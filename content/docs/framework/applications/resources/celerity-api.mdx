...
When set to `true`, OpenTelemetry will be enabled for Azure Functions. This feature is currently in preview (June 2026) and is only supported for a subset of languages.
