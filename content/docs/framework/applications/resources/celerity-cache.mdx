...
resource sessionCache: celerity/cache {
    metadata {
...
resource getSessionHandler: celerity/handler {
    metadata {
...
resource productCache: celerity/cache {
    metadata {
