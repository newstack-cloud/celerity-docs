...
resource publicAnnouncements: celerity/channel {
    metadata {
        labels = {
            application = "chatApp"
        }
...
resource orgUpdates: celerity/channel {
    metadata {
        labels = {
            application = "chatApp"
        }
...
resource onOrgSubscribe: celerity/handler {
    metadata {
        labels = {
            channel = "orgUpdates"
        }
...
resource onOrgMessage: celerity/handler {
    metadata {
        labels = {
            channel = "orgUpdates"
        }
