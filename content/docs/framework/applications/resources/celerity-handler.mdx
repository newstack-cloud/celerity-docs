...
✅ **Available in v0** - This annotation is applicable for workflow applications deployed to AWS serverless (Step Functions) and local development environments.
...
✅ **Available in v0** - This link is applicable for workflow applications deployed to AWS serverless (Step Functions) and local development environments.
...
|---------|------------|------------------|-----------------|
| Node.js 22 | nodejs22.x | Debian 13 (trixie) | Active |
