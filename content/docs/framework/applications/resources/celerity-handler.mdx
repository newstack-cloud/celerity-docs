...
The Celerity SDK provides a thin cache abstraction (`createCacheClient`) with `get`, `set`, `delete` and `ttl` operations, as well as a credentials provider for direct Redis client access.
...
See the [Runtime Lifecycle & Support Policy](/docs/framework/runtime/lifecycle#aws-lambda) for how Celerity tracks AWS Lambda runtime deprecations.
...
See the [Runtime Lifecycle & Support Policy](/docs/framework/runtime/lifecycle#google-cloud-functions) for how Celerity tracks Google Cloud Functions runtime deprecations.
...
See the [Runtime Lifecycle & Support Policy](/docs/framework/runtime/lifecycle#azure-functions) for how Celerity tracks Azure Functions runtime deprecations.
