...
**Initial Release**: May 31st, 2026
**Evolution Period**: May 2026 - May 2027
...
#### Current v0 Components (May 2026)
...
- **Client SDK for WebSocket APIs**: A single TypeScript package for browsers and Node.js to interact with WebSocket APIs adhering to the [WebSocket Runtime Protocol](/docs/runtime/websocket-runtime-protocol), that are also compatible with AWS API Gateway v2 WebSocket APIs.
...
#### Current v0 Resource Types (May 2026)
...
- `celerity/cache` - AWS ElastiCache for Redis with a thin cache abstraction (get/set/delete/ttl).
...
- **Client SDK for WebSocket APIs**: Client SDKs for browsers, Node.js and Python to interact with WebSocket APIs adhering to the [WebSocket Runtime Protocol](/docs/runtime/websocket-runtime-protocol), that are also compatible with AWS API Gateway v2 WebSocket APIs. v1 adds a Python WebSocket client SDK.
