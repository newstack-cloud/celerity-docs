...
- **On-premise** - No support planned for v1, considered for the future.

### v1+ (Future) - Post-v1 Features

v1+ represents features that are planned for after the v1 release in July 2027. These are features that have been designed but are not part of the v1 roadmap.
