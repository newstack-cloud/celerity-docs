...
**Initial Release**: June 30th, 2026
**Evolution Period**: June 2026 - June 2027
...
#### Current v0 Components (June 2026)
...
#### Current v0 Resource Types (June 2026)
...
- `celerity/datastore` - AWS DynamoDB tables with built-in schema management (schema-as-code, type generation, schema contracts, data team exports).
...
- `celerity/sqlDatabase` - AWS RDS for PostgreSQL with built-in schema management (migration engine, schema-as-code, type generation).
...
v1+ represents features that are planned for after the v1 release in June 2027. These are features that have been designed but are not part of the v1 roadmap.
...
- **Draft Status**: Will remain in draft until v1 release (June 2027)
- **Blueprint transform**: Matches the spec version

### 2) Ecosystem Compatibility
- **v0**: Current capabilities (continuously evolving)
- **v1**: Full planned capabilities (target: June 2027)
...
2. **v1 Release**: `v2027-05-31` (stable, no draft suffix)
