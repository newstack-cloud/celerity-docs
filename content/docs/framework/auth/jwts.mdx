---
title: JWTs
description: JWTs for Celerity components with HTTP APIs
---

JWTs (JSON Web Tokens) can be used to authenticate with Celerity components that provide HTTP APIs such as the [Workflow Runtime](/docs/workflow-runtime).
