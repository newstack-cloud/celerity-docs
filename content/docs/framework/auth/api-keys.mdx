---
title: API Keys
description: API keys for Celerity components with HTTP APIs
---

API keys can be used to authenticate with Celerity components with HTTP APIs such as the [Workflow Runtime](/docs/workflow-runtime).
