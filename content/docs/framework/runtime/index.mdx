---
title: Introduction
description: Introduction to Celerity runtimes
---
...
```blueprintlang title="/application.bp"
version "2025-11-02"
...
The Celerity runtime provides tailored SDK support for the following languages. In v0, Node.js (TypeScript) and Python are available; Go, C# and Java are planned for v1. See the [Celerity versions](/docs/framework/versions) documentation for the full roadmap.

| Language | Tailored SDK support |
|---|---|
| Node.js (TypeScript) | ✅ Available in v0 |
| Python | ✅ Available in v0 |
| Go | 🚀 Planned for v1 |
| C# | 🚀 Planned for v1 |
| Java | 🚀 Planned for v1 |

<Callout title="Ahead-of-time compiled languages" type="info">
🚀 **Planned for v1** — In v1, the runtime will also support any other language that can be compiled ahead of time into an executable binary. Languages such as Rust, C++, C or Zig will be usable but lack the official SDK support that the languages listed above have; for these languages you will be able to use the [Local Runtime API](#) to interact with the runtime from your handler code.
</Callout>
